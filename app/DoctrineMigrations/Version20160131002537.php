...
class Version20160131002537 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE purchasable_image (article_id INT NOT NULL, image_id INT NOT NULL, INDEX IDX_3A78D4124584665A (article_id), INDEX IDX_3A78D4123DA5256D (image_id), PRIMARY KEY(article_id, image_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE article (id INT NOT NULL, principal_variant_id INT DEFAULT NULL, INDEX IDX_D34A04ADE2560A82 (principal_variant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE article_attribute (article_id INT NOT NULL, attribute_id INT NOT NULL, INDEX IDX_94DA59764584665A (article_id), INDEX IDX_94DA5976B6E62EFA (attribute_id), PRIMARY KEY(article_id, attribute_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE purchasable_image ADD CONSTRAINT FK_3A78D4124584665A FOREIGN KEY (article_id) REFERENCES purchasable (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE article ADD CONSTRAINT FK_D34A04ADE2560A82 FOREIGN KEY (principal_variant_id) REFERENCES variant (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE article ADD CONSTRAINT FK_D34A04ADBF396750 FOREIGN KEY (id) REFERENCES purchasable (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE article_attribute ADD CONSTRAINT FK_94DA59764584665A FOREIGN KEY (article_id) REFERENCES article (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE article_attribute ADD CONSTRAINT FK_94DA5976B6E62EFA FOREIGN KEY (attribute_id) REFERENCES attribute (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE article_attribute DROP FOREIGN KEY FK_94DA5976B6E62EFA');
        ...
        $this->addSql('ALTER TABLE article DROP FOREIGN KEY FK_D34A04ADBF396750');
        ...
        $this->addSql('ALTER TABLE article_attribute DROP FOREIGN KEY FK_94DA59764584665A');
        $this->addSql('ALTER TABLE variant DROP FOREIGN KEY FK_F143BFAD4584665A');
        $this->addSql('ALTER TABLE article DROP FOREIGN KEY FK_D34A04ADE2560A82');
