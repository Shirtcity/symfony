...
namespace Plugin\StoreSetupWizardBundle\Templating;
...
use Plugin\StoreSetupWizardBundle\Services\WizardRoutes;
use Plugin\StoreSetupWizardBundle\Services\WizardStatus;
