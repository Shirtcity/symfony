...
namespace Plugin\PaypalWebCheckoutBundle;
...
use Plugin\PaypalWebCheckoutBundle\DependencyInjection\ElcodiPaypalWebCheckoutExtension;
...
class ElcodiPaypalWebCheckoutBundle extends AbstractElcodiBundle implements PluginInterface, DependentBundleInterface
{
    ...
    {
        return [
            'Bridge\PaymentSuiteBridgeBundle\ElcodiPaymentSuiteBridgeBundle',
