...
namespace Plugin\CustomShippingBundle;
...
use Plugin\CustomShippingBundle\CompilerPass\MappingCompilerPass;
use Plugin\CustomShippingBundle\DependencyInjection\ElcodiCustomShippingExtension;
