...
namespace Plugin\CustomShippingBundle\DependencyInjection;
...
class ElcodiCustomShippingExtension extends AbstractExtension implements EntitiesOverridableExtensionInterface
{
    ...
    {
        return [
            'Plugin\CustomShippingBundle\Entity\Interfaces\CarrierInterface'       => 'elcodi.entity.carrier.class',
            'Plugin\CustomShippingBundle\Entity\Interfaces\ShippingRangeInterface' => 'elcodi.entity.shipping_range.class',
        ];
    }
