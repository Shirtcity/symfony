...
namespace Plugin\CustomShippingBundle\Tests\UnitTest\Provider;
...
use Plugin\CustomShippingBundle\ElcodiShippingRangeTypes;
use Plugin\CustomShippingBundle\Entity\Interfaces\CarrierInterface;
use Plugin\CustomShippingBundle\Entity\Interfaces\ShippingRangeInterface;
use Plugin\CustomShippingBundle\Provider\ShippingRangesProvider;
use Plugin\CustomShippingBundle\Repository\CarrierRepository;
...
class ShippingRangesProviderTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        return $this->prophesize('Plugin\CustomShippingBundle\Repository\CarrierRepository');
    }
    ...
    {
        $carrier = $this->prophesize('Plugin\CustomShippingBundle\Entity\Interfaces\CarrierInterface');
    ...
    {
        return $this->prophesize('Plugin\CustomShippingBundle\Entity\Interfaces\ShippingRangeInterface');
    }
