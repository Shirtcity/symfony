...
namespace Elcodi\Component\Article\Tests\UnitTest\StockValidator;

use Doctrine\Common\Collections\ArrayCollection;
use PHPUnit_Framework_TestCase;

use Elcodi\Component\Article\ElcodiArticleStock;
use Elcodi\Component\Article\StockValidator\PackStockValidator;
...
use Elcodi\Component\Article\StockValidator\VariantStockValidator;
...
class PackStockValidatorTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testIsValidPack(
        ...
        $pack = $pack->reveal();
        $packValidator = new PackStockValidator();
        $packValidator->addPurchasableStockValidator(new ArticleStockValidator());
        ...
        $purchasableValidator->addPurchasableStockValidator(new ArticleStockValidator());
    ...
    public function dataIsValidPack()
    {
        ...
        return [
            ...
            // Changes only article
            'Prod: Article disabled' => [true, $inhStock, null, false, 3, true, 3, 2, true, false],
            ...
            'Prod: Article without stock' => [true, $inhStock, null, true, 0, true, 3, 3, true, false],
            ...
            // With inheritance stock + Article enabled and stock 3
