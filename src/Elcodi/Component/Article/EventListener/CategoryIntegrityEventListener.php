...
use Elcodi\Component\Article\Entity\Interfaces\CategorizableInterface;
use Elcodi\Component\Article\Services\CategoryIntegrityFixer;
...
class CategoryIntegrityEventListener
{
    ...
    /**
     * Before the flush we check that the article categories are right.
     *
    ...
    /**
     * Before an update we check that the article categories are right.
     *
