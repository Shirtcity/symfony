...
class PackType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('stockType', 'choice', [
                'choices'           => [
                    'admin.purchasable_pack.field.stock_type.specific_stock' => ElcodiArticleStock::SPECIFIC_STOCK,
                    'admin.purchasable_pack.field.stock_type.inherit_stock'  => ElcodiArticleStock::INHERIT_STOCK,
                ],
    ...
    {
        return 'elcodi_admin_article_form_type_purchasable_pack';
    }
