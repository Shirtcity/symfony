...
class PackComponentController extends AbstractAdminController
{
     ...
     *      methods = {"GET"}
     * )
     * @Template("AdminArticleBundleBak:Pack:listComponent.html.twig")
     *
     * @PaginatorAnnotation(
     ...
     *      methods = {"GET"}
     * )
     * @Template("AdminArticleBundleBak:Pack:editComponent.html.twig")
     *
     * @EntityAnnotation(
     *      class = {
     ...
     * )
     * @FormAnnotation(
     *      class = "elcodi_admin_article_form_type_purchasable_pack",
     *      name  = "formView",
     *      entity = "pack",
     *      handleRequest = true,
     *      validate = "isValid"
