...
namespace Elcodi\Plugin\ArticleCsvBundle\DependencyInjection;

use Elcodi\Bundle\CoreBundle\DependencyInjection\Abstracts\AbstractExtension;

/**
 * Class ElcodiArticleCsvExtension
 *
 * @author Berny Cantos <be@rny.cc>
 */
class ElcodiArticleCsvExtension extends AbstractExtension
{
    /**
