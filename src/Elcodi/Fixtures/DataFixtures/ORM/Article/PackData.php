...
class PackData extends AbstractPurchasableData implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $pack4flavors = $packDirector
            ...
            ->addPurchasable($this->getReference('article-ibiza-banana'))
            ->addPurchasable($this->getReference('article-i-was-there'))
            ->addPurchasable($this->getReference('article-a-life-style'))
    ...
    {
        return [
            'Elcodi\Fixtures\DataFixtures\ORM\Article\ArticleData',
