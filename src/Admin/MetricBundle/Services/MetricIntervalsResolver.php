...
namespace Admin\MetricBundle\Services;

use DateTime;

use Admin\MetricBundle\AdminPanelTypes;
use Admin\MetricBundle\Model\IntervalContainer;
use Admin\MetricBundle\Model\PartialInterval;
