...
class StoreCoreExtension extends AbstractExtension
{
    ...
    {	
        return [
			'elcodi.entity.custom_article.class' => $config['mapping']['custom_article']['class'],
			'elcodi.entity.custom_article.mapping_file' => $config['mapping']['custom_article']['mapping_file'],
			'elcodi.entity.custom_article.manager' => $config['mapping']['custom_article']['manager'],
            'elcodi.entity.custom_article.enabled' => $config['mapping']['custom_article']['enabled'],
		];
	}
    ...
    {
        return [
            'Elcodi\Component\Product\Entity\Interfaces\ProductInterface' => 'elcodi.entity.custom_article.class',
        ];
    }*/
