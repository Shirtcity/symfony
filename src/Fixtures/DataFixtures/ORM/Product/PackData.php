...
namespace Fixtures\DataFixtures\ORM\Product;
...
use Fixtures\DataFixtures\ORM\Product\Abstracts\AbstractPurchasableData;
...
class PackData extends AbstractPurchasableData implements DependentFixtureInterface
{
    ...
    {
        return [
            'Fixtures\DataFixtures\ORM\Product\ProductData',
            'Fixtures\DataFixtures\ORM\Currency\CurrencyData',
            'Fixtures\DataFixtures\ORM\Category\CategoryData',
            'Fixtures\DataFixtures\ORM\Manufacturer\ManufacturerData',
            'Fixtures\DataFixtures\ORM\Attribute\AttributeData',
            'Fixtures\DataFixtures\ORM\Store\StoreData',
        ];
    }
}
